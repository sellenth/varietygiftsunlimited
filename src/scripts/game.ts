...
// If you're using WebGLRenderer, make sure legacy lights are disabled (default in r155+)
renderer.useLegacyLights = false;  // This line is optional in r155+ as it's the default

// Reduce directional light intensity

// Add subtle ambient light
const ambientLight = new THREE.AmbientLight(0x404040, 0.1);  // Reduce intensity
...
const planeGeometry2 = new THREE.PlaneGeometry( 20, 20, 32, 32 );
