...
/** @type {string} */
const CACHE_VERSION = '1726968103|20041544988';
/** @type {string} */
const CACHE_PREFIX = 'savingsbox-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'savingsbox.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["savingsbox.html","savingsbox.js","savingsbox.offline.html","savingsbox.icon.png","savingsbox.apple-touch-icon.png","savingsbox.worker.js","savingsbox.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["savingsbox.wasm","savingsbox.pck"];
